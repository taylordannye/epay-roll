            ...
            <div class="auth-wrapper">
                <form action="#" method="POST" autocomplete="off" class="onboarding" id="onboarding">
                    ...
                    <button type="button" class="o2auth-wrapper">
                        <img class="o2auth-img" src="{{ asset('storage/assets/images/02auth/29b6600agh288c2748374jjfd8439843.png') }}" alt="Google">
                    ...
                    <div class="btn-group">
                        <button type="submit" class="submit-btn">Get Signup Authorization</button>
                    </div>
